            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="mb-16 text-center">
                    ...
                    <p className="text-slate-500 max-w-xl mx-auto">
                        Our multi-agent system reads, reasons, and writes like a
                        senior analyst, but at machine speed
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[400px]">
                    ...
                    <div className="md:col-span-2 rounded-[32px] p-8 md:p-12 relative overflow-hidden group shadow-sm hover:shadow-xl transition-all duration-500 border bg-white border-slate-100">
                        <div className="relative z-10 max-w-md">
                            ...
                            <p className="text-slate-500 leading-relaxed">
                                We deploy specialized agents for every dimension
                                of the deal. The <strong>Market Agent</strong>{" "}
                                validates TAM/SAM, the{" "}
                                <strong>Technical Agent</strong> audits the
                                stack, and the <strong>Risk Agent</strong>{" "}
                                stress-tests assumptions—all in parallel.
                            </p>
                        </div>
                    ...
                    <div className="rounded-[32px] p-8 md:p-12 relative overflow-hidden shadow-2xl flex flex-col justify-between bg-black text-white">
                        <div>
                            ...
                            <p className="text-sm leading-relaxed text-white/60">
                                Don't wait for a call. AI-Shark simulates
                                founder responses to standard due diligence
                                questionnaires using uploaded data context.
                            </p>
                        </div>
                        ...
                        <div className="mt-8 backdrop-blur-md rounded-xl p-4 border bg-white/10 border-white/10">
                            ...
                            <div className="flex gap-3">
                                ...
                                <span className="text-xs text-white/60">
                                    "Based on our Series A deck, CAC reduces by
                                    20% via network effects..."
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="rounded-[32px] p-8 md:p-12 relative overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border flex flex-col bg-white border-slate-100">
                        ...
                        <p className="text-slate-500 text-sm mb-8">
                            We handle PDFs, PPTX, transcripts, and emails to
                            build a complete graph of the company.
                        </p>
                        ...
                        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center h-full">
                            <div>
                                ...
                                <p className="leading-relaxed text-blue-100">
                                    Configurable templates allow you to weight
                                    analysis towards "Market-Focused",
                                    "Tech-Focused", or "Balanced" perspectives
                                    before exporting to DOCX or Markdown.
                                </p>
