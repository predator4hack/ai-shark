            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <p className="text-lg mb-8 font-light max-w-md text-white/60">
                        A sophisticated multi-phase pipeline that ensures no
                        detail in the data room goes unnoticed.
                    </p>
                    ...
                    <ul className="space-y-8 relative">
                        ...
                        <li className="flex items-start gap-6 relative">
                            ...
                            <div>
                                ...
                                <p className="text-xs mt-1 text-white/50">
                                    OCR and extraction from PDF/PPTX, creating
                                    structured context.
                                </p>
                            </div>
                        </li>
                        <li className="flex items-start gap-6 relative">
                            ...
                            <div>
                                ...
                                <p className="text-xs mt-1 text-white/50">
                                    Business, Market, Tech, and Risk agents
                        ...
                        <li className="flex items-start gap-6 relative">
                            ...
                            <div>
                                ...
                                <p className="text-xs mt-1 text-white/50">
                                    Aggregating findings into a cohesive
                                    narrative with weighted scoring.
                                </p>
                            </div>
                        </li>
                    </ul>
