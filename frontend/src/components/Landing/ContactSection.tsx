    ...
    <section id="contact" className="py-24 bg-white">
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        <p className="text-slate-500 mb-10">
          Join the waiting list or get in touch to schedule a personalized walkthrough of the
          AI-Shark platform.
        </p>
        ...
        <p className="text-xs text-slate-400 mt-6">
          ...
          <a href="mailto:hello@aishark.vc" className="text-blue-600 hover:underline">
            hello@aishark.vc
          </a>
        </p>
      </div>
